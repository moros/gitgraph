...
impl Point {
    ...
    /// Returns true if this point is inside the convex polygon defined by `vertices`.
...
/// Returns the bounding box of `points` as (min_x, min_y, max_x, max_y) in u32.
...
mod tests {
    ...
    fn test_point_inside_polygon() {
        ...
        assert!(Point::new(0.5, 0.5).is_inside_polygon(&square));
        assert!(!Point::new(2.0, 2.0).is_inside_polygon(&square));
    }
    ...
    fn test_vector_perpendicular() {
        ...
        assert_eq!(p, Vector::new(0.0, 1.0));
    ...
    fn test_bounding_box() {
        ...
        assert_eq!(bounding_box_u32(&pts), (1, 2, 5, 7));
    }
}
